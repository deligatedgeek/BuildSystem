...
resource "esxi_guest" "home-esx-pup-01" {
  guest_name = "home-esx-hap-01" # Required, Specify the Guest Name
  guestos    = "centos9-64"
  notes      = "Home HAProxy Server"
  ...
  ovf_source = "../../ova/packer-home-rock9-cloud.ova"
  guestinfo = {
    "metadata.encoding" = "gzip+base64",
    "metadata"          = base64gzip(templatefile("metadata.tpl",{
      HOSTNAME = "home-esx-hap-01"
    ...
    "userdata"          = base64gzip(templatefile("userdata.tpl",{
      HOSTNAME = "home-esx-hap-01"
    }))
  }
}
